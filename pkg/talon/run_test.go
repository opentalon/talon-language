...
func TestNewDatalevinFactStore_FailsAtFirstUse(t *testing.T) {
	...
	fs := talon.NewDatalevinFactStore("http://127.0.0.1:1")
	if fs == nil {
		t.Fatal("NewDatalevinFactStore returned nil")
	}
